"""
    ...
    @version: 1.0.0
    @description:
                This library contains the module of the BLS algorithm with cascades of mapped
                features and enhancement nodes (CFEBLS). It includes the function
                'cfebls_train_fscore.'
...
"""
    ...
    testing time, and testing F-Score.
        cfebls_train_fscore(train_x, train_y, test_x, test_y, s, C, N1, N2, N3)
    ...
    'wha2,' respectively.
"""
def cfebls_train_fscore(train_x, train_y, test_x, test_y, s, C, N1, N2, N3):
    ...
    print ("Testing Fscore is : ", f_score * 100, " %");
