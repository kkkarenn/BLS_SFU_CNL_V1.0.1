"""
    ...
    @description:
                ...
                mapped features and enhancement nodes (CFEBLS). It includes the function
                'cfbls_train_fscore_incremental.'
    ...
    MATLAB code (version 2017b) is implemented based on bls_train_inputehnacen_fscore.m and
    equations in C. L. P. Chen, Z. Liu, and S. Feng, “Universal approximation capability of broad
    learning system and its structural variations,” IEEE Trans. Neural Netw. Learn. Syst., pp.
    1–14, Sept. 2018.
"""

######################################################
####### CFEBLS (incremental)
# Module of the CFEBLS algorithm 
...
"""
    Function that creates the CFEBLS model with increments of cascades of enhancement nodes and new
    ...
    training and testing time, and testing F-Score.
        cfebls_train_fscore_incremental(train_x, train_y, train_xf, train_yf, test_x, test_y, s, C,
            N1, N2, N3, inputData, m, m2, l)
    ...
    Randomoly generated weights for the first mapped feature, first enhancement node, and cascades
    of mapped features and enhancement nodes are stored in the matrices 'we', 'wh,' 'wha,' and
    'wha2,' respectively.
"""
def cfebls_train_fscore_incremental(train_x, train_y, train_xf, train_yf, test_x, test_y, s, C, N1, N2, N3, inputData, m, m2, l):
    ...
    for i in range(0, N2):
        ...
        # Cascades of maaped features
        wha = orth( 2.0 * np.random.rand(N1, N1) - 1.0 );
        wha_list_f.append(wha);
    ...
    ### Generatio of enhancement nodes
    ...
    for e in range(0, l - 1):
        ...
        # Concatenate enhancement nodes with added cascade of enhancement nodes/step
        ...
        # Note that added cascades ofenhancement nodes were generated by enhancement nodes in step
        # e=0 while added enhancement nodes were generated by previous added enhancement nodes from
        # step e=1.
        if e == 0:
