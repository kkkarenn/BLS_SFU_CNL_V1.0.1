"""
    ...
    @description:
                ...
                (RBF-BLS). It includes the function 'rbfbls_train_fscore_incremental.'
...
######################################################
####### RBF-BLS (incremental)
# Module of the RBF-BLS algorithm 
...
"""
    Function that creates the RBF-BLS model with increments of enhancement nodes and new input
    data for a given dataset and tests the model. It returns the training and test accuracy,
    training and testing time, and testing F-Score.
        rbfbls_train_fscore_incremental(train_x, train_y, train_xf, train_yf, test_x, test_y, s, C,
